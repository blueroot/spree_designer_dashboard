module SpreeDesignerDashboard
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        inject_into_file 'app/assets/stylesheets/store/all.css', " *= require store/spree_designer_dashboard\n", :before => /\*\//, :verbose => true
        inject_into_file 'app/assets/stylesheets/admin/all.css', " *= require admin/spree_designer_dashboard\n", :before => /\*\//, :verbose => true
      end

      def add_migrations
        run 'bundle exec rake railties:install:migrations FROM=spree_designer_dashboard'
      end
