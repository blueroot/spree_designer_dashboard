class Spree::Admin::BoardsController < Spree::Admin::ResourceController
  ...
  def index
    ...
    @boards = Spree::Board.includes({:board_products => {:product => [{:master => [:stock_items, :images, :prices]}, :supplier]}}, :board_image, :designer).page(params[:page] || 1).per(params[:per_page] || 3)
